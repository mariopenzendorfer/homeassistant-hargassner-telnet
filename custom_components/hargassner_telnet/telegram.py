...
_FIELD_CONFIG = {
    ...
    "RLm_auf": BinaryFormatter("HV Rücklaufmischer auf"),
    "RLm_zu": BinaryFormatter("HV Rücklaufmischer zu"),
    ...
    "PK_RLm_zu": BinaryFormatter("PK Rücklaufmischer zu"),
    # "PK_RL Pumpe": BinaryFormatter("PK_RL Pumpe"),
